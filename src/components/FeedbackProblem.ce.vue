            ...
            <fieldset id="reportAProblemInputs">
              ...
              <!-- vee-validate parameters only have to be set on one element with the same name -->
                ...
                <checkbox-item 
                  ...
                  value="spellingOrGrammarMistakes"
                  @change="handleReasonsChanged"
                >
                ...
                <div v-if="isReasonOtherSelected" class="form-group">
                  <textarea-input
                    ...
                    >{{ t("form.specify") }} ({{ t("form.max750characters") }})
                    </textarea-input>
            ...
            <div>
                <div class="alert alert-info">
                    ...
                    <ul>
                        ...
                        <li>
                            <small>
                                <strong>{{ t('submissionInformation.forMoreInfo')}}</strong>, {{ t('submissionInformation.referTo')}} <a :href="`${websiteBasePath}${t('submissionInformation.termsOfUseLink')}`">{{ t('submissionInformation.termsOfUse')}}</a>.
                            </small>
                        </li>
                    </ul>
                </div>
